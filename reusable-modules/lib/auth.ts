 ...
 *
 * 依赖：
 * - @/lib/openclaw —— 必须导出 `openClawClient` 单例，含 connect/sendChatToSession/subscribe
 * - @/config —— storageKey() 工具
 */
...
/** sessionToken 在 localStorage 的 key（带项目前缀） */
const TOKEN_STORAGE_KEY = storageKey("session_token");
